...
export function Payslip({ data }: { data: PayslipData }) {
  ...
  return (
    <div className="w-full p-0 bg-white" style={{fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", lineHeight: '1.4'}}>
      ...
      {/* Earnings Table with Deductions */}
      <div className="p-6 border-b border-gray-300">
        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tfoot>
            ...
            <tr className="font-bold bg-gray-50">
              <td className="border border-gray-300 px-3 py-2 text-black">Net Salary Credited-</td>
              <td colSpan={4} className="border border-gray-300 px-3 py-2 text-black text-right">₹ {formatCurrency(data.netSalaryCredited)}</td>
            </tr>
          </tfoot>
        </table>
      </div>
